...
import com.example.myrecipeapp.databinding.SearchRecyclerViewBinding
...
class SearchAdapter (var dataList: ArrayList<Recipe>,var context: Context):RecyclerView.Adapter<SearchAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var view=SearchRecyclerViewBinding.inflate(LayoutInflater.from(context),parent,false)
